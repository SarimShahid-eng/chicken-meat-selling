    ...
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Manage and configure your wholesale chicken meat suppliers inventory
                    profiles.</p>
            </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                placeholder="e.g., Farm Fresh Poultry"
                        ...
                        <div class="relative">
                            ...
                            <select id="region_id" name="region_id" required
                                ...
                                <option value="" disabled
                                    {{ old('region_id') === null && !isset($supplier) ? 'selected' : '' }}>
                                    Select a region
                                </option>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" id="date" name="date"
                                value="{{ old('date', isset($supplier) ? date('Y-m-d', strtotime($supplier->date)) : date('Y-m-d')) }}"
