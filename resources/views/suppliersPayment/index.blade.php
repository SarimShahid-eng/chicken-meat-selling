...
@section('content')
    <div class="space-y-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 tracking-tight">SuppliersPayment</h1>
                <p class="text-gray-500 mt-1 text-sm">Manage your chicken meat suppliers payment and stock levels</p>
            </div>
        ...
        <div class="flex justify-start">
            <div class="w-full max-w-[600px] bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                ...
                <div class="flex items-center gap-2">
                    <form action="{{ route('suppliersPayment.index') }}" method="GET"
                        ...
                        <div class="relative ">
                            ...
                            <input type="text" value="{{ filled(request()->search) ? request()->search : '' }}"
                                placeholder="Search suppliersPayments..." name="search"
                ...
                <table class="w-full border-collapse text-left text-sm text-gray-500">
                    <thead class="bg-gray-50/70 border-b border-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-4 font-semibold text-gray-700">Amount</th>
                            ...
                            <th scope="col" class="px-6 py-4 font-semibold text-gray-700">Type</th>
                            <th scope="col" class="px-6 py-4 font-semibold text-gray-700 text-right">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                        @forelse ($suppliersPayments as $supplierPayment)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-gray-500">
                                    <div class="max-w-xs truncate" title="{{ $supplierPayment->amount }}">
                                        {{ $supplierPayment->amount }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-gray-500">
                                    <div class="max-w-xs truncate" title="{{ $supplierPayment->description }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="inline-flex items-center gap-3">
                                        <a href="{{ route('suppliersPayment.edit', ['payment' => $supplierPayment->id]) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="text-gray-500 font-medium">No suppliersPayments found</p>
