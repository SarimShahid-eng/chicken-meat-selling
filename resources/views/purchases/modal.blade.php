        ...
        <div class="relative bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden animate-fade-in">
            ...
            <div class="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div id="modalContent" class="hidden space-y-4">
                    ...
                    {{-- Vehicles Table --}}
                    <div>
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Vehicles List</p>
                        <div class="border border-gray-100 rounded-lg overflow-hidden bg-gray-50/50">
                            <table class="w-full text-left text-sm">
                                <thead class="bg-gray-100/70 text-xs font-semibold text-gray-500 uppercase">
                                    <tr>
